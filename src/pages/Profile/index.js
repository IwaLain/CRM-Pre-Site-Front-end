...
const ProfilePage = () => {
  ...
  const toggleEditProfile = () =>
    dispatch({ modalEditProfile: !modalEditProfile });
  ...
  const checkImgProfile = (newLoadedImg) => {
    if (newLoadedImg === null || "") {
      ...
      if (newLoadedImg.includes("blob:")) return newLoadedImg;
      else return process.env.REACT_APP_SERVER_URL + "/" + newLoadedImg;
    }
  };
  ...
  const setNewImage = (newImage) => {
    ...
    Profile.updateProfile(profile.id, data).then((data) => {
    ...
    <div className="profile">
      ...
      <Row>
        ...
        <div className="profile__btn" key="profile__btn">
          <button className="ui-btn ui-btn-primary" onClick={toggleEditProfile}>
