...
const networkApi = {
  ...
  getByCustomerGetaway: async (id) => {
    ...
    if (token)
      return await apiRequest('GET', BASE_URL + `/api/customer/${id}/gateway?access-token=${token}`)
  },
  ...
  getByFacilityGetaway: async (id) => {
    ...
    if (token)
      return await apiRequest('GET', BASE_URL + `/api/facility/${id}/gateway?access-token=${token}`)
  },
  ...
  getTypeImageGetaway: async (id) => {
    ...
    if (token)
      return await apiRequest('GET', BASE_URL + `/api/gateway/type-images?access-token=${token}`)
  },
  ...
  deleteNode: async (id) => {
    ...
    if (token)
      return await apiRequest('DELETE', BASE_URL + `/api/delete/delete/${id}?access-token=${token}`)
  },
  ...
  deleteMote: async (id) => {
    ...
    if (token)
      return await apiRequest('DELETE', BASE_URL + `/api/mote/delete/${id}?access-token=${token}`)
  },
  ...
  getSensor: async (id) => {
    ...
    if (token)
      return await apiRequest('GET', BASE_URL + `/api/sensor/${id}?access-token=${token}`, {}, {})
  },
  ...
  deleteSensor: async (id) => {
    ...
    if (token)
      return await apiRequest('DELETE', BASE_URL + `/api/sensor/delete/${id}?access-token=${token}`)
  }
}
