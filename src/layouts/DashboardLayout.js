...
const DashboardLayout = ({ children }) => {
    ...
    return (
        <div className="dashboard container-fluid">
            <div className="row">
                {!sidebarCollapsed && sidebarNeeded && <Sidebar isMobile={isMobile} sidebarNeeded={sidebarNeeded} toggleSidebar={toggleSidebar}/> }
                <section className={(isMobile || !sidebarNeeded) ? 'col-12': 'col-10'}>
                    <Header sidebarNeeded={sidebarNeeded} isMobile={isMobile} toggleSidebar={toggleSidebar}/>
                    <main>
