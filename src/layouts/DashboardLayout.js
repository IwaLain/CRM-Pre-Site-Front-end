        ...
        <div className="dashboard container-fluid">
            <div className="row">
                ...
                <aside className={isMobile ? 'col-12': 'col-2'}>
                    ...
                    <nav>
                        <ul>
                            <li><a href="/dashboard">Facilities</a></li>
                            <li><a href="/dashboard">Equipment</a></li>
                        </ul>
                    </nav>
                </aside>
                }
                <section className={(isMobile || !sidebarNeeded) ? 'col-12': 'col-10'}>
                    ...
                    <button className={(isMobile && sidebarNeeded) ? 'burger-btn': 'burger-btn hidden'} onClick={toggleSidebar}>
